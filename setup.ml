...
(* OASIS_START *)
(* DO NOT EDIT (digest: da263a682a4702b52feb025fb469759b) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_optparse", []))];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["BatOptParse"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "batteries_optparse";
                      lib_findlib_containers = []
                   });
               Test
                 ({
                     cs_name = "test_optparse";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "batteries_optparse";
                   ...
                   {exec_custom = true; exec_main_is = "test_optparse.ml"})
            ];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "ë­\151\020¦©ì<\147xüÀ\155B\022b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
