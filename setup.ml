...
(* OASIS_START *)
(* DO NOT EDIT (digest: eadf21f29588828af9fd7670c7da66ae) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "batteries.optparse";
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "-­½M\017i\030©\128[Ý\018k·üö";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
